module room {
	export class RoomSocketSender {
		...
		public HEART_BEAT(): void {
			...
			room.RoomWebSocket.instance().SendMeseage(RoomProtocol.REQ | RoomProtocol.VGID_HEART_BEAT, body);
		}
		public REQ_LOGIN(): void {
			...
			console.log("客户端发送登录请求" + Global.token,RoomProtocol.VGID_ROOM_LOGIN);
			
			room.RoomWebSocket.instance().SendMeseage(RoomProtocol.REQ | RoomProtocol.VGID_ROOM_LOGIN, body);
		}
		/*
		*请求房间列表
		*/
		public REQ_ROOMLIST(): void {
			...
			room.RoomWebSocket.instance().SendMeseage(RoomProtocol.REQ | RoomProtocol.VGID_ROOM_ROOMLIST, body);
		}
		...
		*/
		public REQ_ROOMLeaveRoomReq(pos: any): void {
			...
			room.RoomWebSocket.instance().SendMeseage(RoomProtocol.REQ | RoomProtocol.VGID_ROOM_SITUP, body);
		}
