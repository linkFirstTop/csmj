module game {
	export class GameSocketReceive {
		...
		public initHandlers(id: number,byte: egret.ByteArray): void {
			// Global.Log("game get msg id：0x"+id.toString(16));
			switch(id)
			{
		...
		// 	var body:proto.AckEnterGame = proto.AckEnterGame.decode(byte.bytes);
		...
		// 		//TipsUtils.showTipsFromCenter( "游戏已经结束，请再来一局");
		...
		// {
		// 	var body:proto.AckGameOver = proto.AckGameOver.decode(byte.bytes);
