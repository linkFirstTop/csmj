module game {
	export class GameZhuaPaiQiUI extends egret.Sprite {
		...
		private init(): void {
			...
			item12.x = 210;
			item12.y = Math.floor(26 / 9) * 50 + Math.floor(26 / 9) * 25 + 325;
			...
			item13.y = Math.floor(26 / 9) * 50 + Math.floor(26 / 9) * 25 + 325;
			...
			itemModel.graphics.drawRect(0, 0, 100, 50);
			itemModel.graphics.endFill();
			itemModel.alpha = 0.8;
			itemModel.name = "model";
			this.btnItem.addChild(itemModel);
			itemModel.x = item12.x + item12.width + 100;
			itemModel.y = Math.floor(26 / 9) * 50 + Math.floor(26 / 9) * 25 + 325;
			...
			btnDel.x = 10;
			btnDel.y = Math.floor(26 / 9) * 50 + Math.floor(26 / 9) * 25 + 325;
