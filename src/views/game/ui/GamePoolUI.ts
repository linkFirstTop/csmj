module game {
  export class GamePoolUI extends eui.Component implements eui.UIComponent {
    ...
    private arrRP: Array<any> = [
      { x: 1107, y: 750 },
      { x: 1107 - 18, y: 750 - 50 },
      { x: 1107 - 18 * 2, y: 750 - 50 * 2 },
      { x: 1107 - 18 * 3, y: 750 - 50 * 3 },
      { x: 1107 - 18 * 4, y: 750 - 50 * 4 },
      { x: 1107 - 18 * 5, y: 750 - 50 * 5 },

      { x: 1198, y: 750 },
      { x: 1198 - 18, y: 750 - 50 },
      { x: 1198 - 18 * 2, y: 750 - 50 * 2 },
      { x: 1198 - 18 * 3, y: 750 - 50 * 3 },
      { x: 1198 - 18 * 4, y: 750 - 50 * 4 },
      { x: 1198 - 18 * 5, y: 750 - 50 * 5 },

      { x: 1289, y: 750 },
      { x: 1289 - 18, y: 750 - 50 },
      { x: 1289 - 18 * 2, y: 750 - 50 * 2 },
      { x: 1289 - 18 * 3, y: 750 - 50 * 3 },
      { x: 1289 - 18 * 4, y: 750 - 50 * 4 },
      { x: 1289 - 18 * 5, y: 750 - 50 * 5 },
    ];
    /*下边玩家牌池坐标*/
